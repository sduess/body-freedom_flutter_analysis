...
def get_settings(flexop_model, flow, dt, **kwargs):
    ...
    settings['StaticTrim'] = {'solver': 'StaticCoupled',
                                ...
                                'tail_cs_index': kwargs.get('trim_cs_index',[4,10]),
                                'thrust_nodes': [0],
                                'fz_tolerance': 1e-6, #10,
                                'fx_tolerance': 1e-6, #10,
                                'm_tolerance': 1e-6, #10,
                                'save_info': True}
    print("Static trim settings", settings['StaticTrim'])
    ...
    settings['StepUvlm'] = {'num_cores': num_cores,
                            'convection_scheme': kwargs.get('convection_scheme', 2),
